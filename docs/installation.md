# Installation
1. Optional (recommended for latest source build): `pnpm install && pnpm build`
2. Install host:
...
3. Load `extension/dist` as unpacked extension (this folder now includes committed fallback build artifacts).
